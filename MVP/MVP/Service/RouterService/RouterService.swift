...
class RouterService: NSObject {
    ...
    func pushMyExercisesViewController() -> Void {
        ...
        myExercisesViewController.addPresenter(presenter: MyExercisesPresenter(withView: myExercisesViewController))
    ...
    func presentAllExercisesViewController() -> Void {
        ...
        allExercisesViewController.presenter = AllExercisesPresenter(withView: allExercisesViewController)
